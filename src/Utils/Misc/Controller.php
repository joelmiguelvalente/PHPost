...
final class Controller
{
	...
	public static function init(string $page, string $access = 'everybody'): self
	{
	    $ctx = self::page($page);
	    $ctx->{$access}();
	    $ctx->exportLegacy();
	...
	public static function render(bool $tsAjax, string $title, string $tsPage): void
	{
    	$smarty = Container::get(tsSmarty::class);
	    if ($tsAjax) {
	        $smarty->assign("tsTitle", $title);
