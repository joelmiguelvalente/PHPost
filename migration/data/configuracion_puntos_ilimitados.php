...
$name = "configuracion_puntos_ilimitados";
...
// Coleccion
$collection = [
	'table_name' =>'w_configuracion',
	'column_name' => 'c_max_points_unlimited'
];

if (!DB::exists($sentence, $collection)) {
   // Ya existe, lo que significa que NO hemos migrado aún
   DB::query("ALTER TABLE w_configuracion ADD c_max_points_unlimited INT NOT NULL DEFAULT 99999");
