                                        ...
                                        <tbody>{foreach from=$tsTemas item=tema}
                                        	<tr>
                                                ...
                                                <td class="admin_actions">
                                                	<a href="?act=editar&tid={$tema.tid}"><img src="{$tsRoutes.tema.images}/icons/editar.png" title="Editar este tema"/></a>
                                                {if $tsConfig.tema_id == $tema.tid}
                                                	<a onclick="return false;"><img src="{$tsRoutes.tema.images}/icons/yes.png" title="Este tema est&aacute; en uso" /></a>
                                                {else}
                                                	<a href="?act=usar&tid={$tema.tid}&tt={$tema.t_name}"><img src="{$tsRoutes.tema.images}/icons/theme.png" title="Usar este tema" /></a>
                                                    {if $tema.tid != 1}<a href="?act=borrar&tid={$tema.tid}&tt={$tema.t_name}"><img src="{$tsRoutes.tema.images}/icons/close.png" title="Borrar este tema" /></a>{/if}
                                                {/if}
                                                </td>
                                            </tr>{/foreach}
                                        </tbody>
