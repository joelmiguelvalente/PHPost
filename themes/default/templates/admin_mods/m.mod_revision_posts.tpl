									...
									<tbody>
										...
										<tr id="report_{$p.post_id}">                                            
											...
											<td class="admin_actions">
													<a href="#" onclick="mod.posts.view({$p.post_id}); return false;"><img src="{$tsRoutes.tema.images}/icons/find.png" title="Ver Post" /></a>
													...
													<a href="#" onclick="mod.posts.borrar({$p.post_id}, false); return false"><img src="{$tsRoutes.tema.images}/icons/close.png" title="Borrar Post" /></a>
											</td>
										</tr>
										{/foreach}
									</tbody>
