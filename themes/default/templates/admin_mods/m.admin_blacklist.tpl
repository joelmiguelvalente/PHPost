                                        ...
                                        <tbody>{foreach from=$tsBlackList.data item=b}
                                        	<tr id="block_{$b.id}">
												...
												<td class="admin_actions">
                                                    <a href="{$tsConfig.url}/admin/blacklist?act=editar&id={$b.id}"><img src="{$tsRoutes.tema.images}/icons/editar.png" title="Editar" /></a>
                                                    <a href="#" onclick="admin.blacklist.borrar({$b.id}); return false"><img src="{$tsRoutes.tema.images}/icons/close.png" title="Eliminar"/></a>
                                                </td>
                                            </tr>{/foreach}
                                        </tbody>
                                        <tfoot>
