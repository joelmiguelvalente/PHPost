										...
										<tbody>
											...
											<tr>
												...
												<td class="admin_actions">
													<a href="{$tsConfig.url}/admin/news/editar/{$n.not_id}"><img src="{$tsRoutes.tema.images}/icons/editar.png" title="Editar" /></a>
													<a onclick="admin.news.accion({$n.not_id}); return false"><img src="{$tsRoutes.tema.images}/reactivar.png" title="Activar/Desactivar Noticia" /></a>
													<a href="{$tsConfig.url}/admin/news?act=borrar&nid={$n.not_id}"><img src="{$tsRoutes.tema.images}/icons/close.png" title="Borrar" /></a>
												</td>
											</tr>
											{/foreach}
										</tbody>
