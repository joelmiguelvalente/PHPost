                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center" id="usuarios">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               ...
                                               <a href="#" onclick="mod.users.action({$u.user_id}, 'ban', false); return false;"><img src="{$tsRoutes.tema.images}/icons/power_off.png" title="Suspender Usuario" /></a>
                                                </td>
                                            </tr>
                                            {/foreach}{else}
                                            <tr>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center" id="posts">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="report_{$r.obj_id}">
                                                ...
                                                <td class="admin_actions">
													<a href="#" onclick="mod.posts.borrar({$p.post_id}, 'posts'); return false"><img src="{$tsRoutes.tema.images}/icons/close.png" title="Borrar Post" /></a>
                                                </td>
                                            </tr>
                                            {/foreach}{else}
                                            <tr>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center" id="fotos">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="admin_actions">
														<a href="#" onclick="mod.fotos.borrar({$f.foto_id}); return false"><img src="{$tsRoutes.tema.images}/icons/close.png" title="Borrar Foto" /></a>                                                </td>
                                            </tr>
                                            {/foreach}{else}
                                            <tr>
