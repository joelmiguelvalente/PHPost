				...
				{else}
					{foreach from=$data item=u}
						<li class="categoriaUsuario categoria-item flex justify-start items-center gap-2">
							...
							<span class="rounded block" style="width: 2rem;">{$u.total}</span>
						</li>
					{/foreach}
				{/if}
			</ol>
