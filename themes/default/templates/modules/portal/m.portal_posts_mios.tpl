                <div class="clearbeta" id="lastPosts">
                    ...
                    <div class="body">
                    	<ul>
                            ...
                            <li class="categoriaPost" style="background-image:url({$tsRoutes['tema:images']}/icons/categories/{$p.c_img})">
                                ...
                                <span>Hace {$p.post_date|hace} &raquo; <a href="{$tsConfig.url}/@{$p.user_name}"><strong>{$p.user_name}</strong></a> &middot; Puntos <strong>{$p.post_puntos}</strong> &middot; Comentarios <strong>{$p.post_comments}</strong></span>
