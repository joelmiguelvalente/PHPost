					<div id="user_box" class="post-autor vcard">
                        ...
                        <div class="tools">
                            ...
                            <hr class="divider"/>
                            <a href="{$tsConfig.url}/agregar/" style="background:url({$tsRoutes.tema.images}/icons/posts.png) no-repeat left center;">Agregar post</a>
                            <a href="{$tsConfig.url}/fotos/agregar.php" style="background:url({$tsRoutes.tema.images}/icons/photo.png) no-repeat left center;">Agregar foto</a>
                            <hr class="divider"/>
