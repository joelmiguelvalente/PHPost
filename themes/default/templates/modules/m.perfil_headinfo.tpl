	...
	<div class="perfil-box clearfix">
		<div class="perfil-data">
			<div class="perfil-avatar">
				<a href="{$tsConfig.url}/perfil/{$tsInfo.nick}" title="{$tsInfo.nick}" rel="internal">
					<img alt="avatar del usuario {$tsInfo.nick}" src="{$tsInfo.user_avatar}" width="120" height="120" loading="lazy" />
				</a>
			</div>
				...
				{if $tsUser->uid != $tsInfo.uid && $tsUser->is_member}
					<div class="ex_opts">
						...
						{if !$tsInfo.user_activo || $tsInfo.user_baneado}
							<span style="background-color:#CE152E;">Cuenta {if !$tsInfo.user_activo}desactivada{else}baneada{/if}</span>
						{/if}
					</div>
					<br />
