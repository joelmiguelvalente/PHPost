						<div class="widget w-stats clearfix">
                        	<div class="title-w clearfix">
                              ...
                              <span title="Online" style="float: left; width: 16px; height: 16px; background: url({$tsRoutes.tema.images}/big2v1.png); background-position: 0 -792px" class="dot-online-offline"></span>
                              {else}
                              <span title="Offline" style="float: left; width: 16px; height: 16px; background: url({$tsRoutes.tema.images}/big2v1.png); background-position: 0 -814px" class="dot-online-offline"></span>
                              </span>
                              {/if}
                            </div>
                        ...
                        <div class="widget w-posts clearfix">
                            ...
                            <ul class="ultimos">
                            	...
                            	<li class="categoriaPost" style="background-image:url({$tsRoutes.tema.images}/icons/cat/{$p.c_img})">
                        ...
                        <div class="widget w-temas clearfix">
                            ...
                            <ul class="ultimos">
                                {foreach from=$tsGeneral.posts item=p}
                            	<li class="categoriaPost" style="background-image:url({$tsRoutes.tema.images}/icons/cat/{$p.s_img})">
