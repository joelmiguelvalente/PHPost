<ul class="post-compartir clearbeta">
				...
				<li class="share-big">
					<a name="fb_share" share_url="{$tsConfig.url}/posts/{$tsPost.categoria.c_seo}/{$tsPost.post_id}/{$tsPost.post_title|seo}.html" type="box_count" href="http://www.facebook.com/sharer">Compartir</a><script src="http://static.ak.fbcdn.net/connect/js/FB.Share" type="text/javascript"></script>
				</li>
				<li class="share-big">
