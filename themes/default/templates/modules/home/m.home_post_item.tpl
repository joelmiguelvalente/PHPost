...
<div class="listPost-item{if $data.post_sponsored == 1} patrocinado{/if}{if $data.post_status >= 1 || $data.post_status <= 3} post_status{$data.post_status}{/if}{if $data.user_activo == 0} user_activo{/if}{if $data.user_baneado == 1} user_baneado{/if}">
