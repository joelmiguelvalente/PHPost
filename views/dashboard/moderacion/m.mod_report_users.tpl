                                        ...
                                        <tbody>
                                            ...
                                            <tr id="report_{$r.obj_id}">
                                                ...
                                                <td class="admin_actions">
                                                    ...
                                                    {if $tsUser->is_admod || $tsUser->can('mosu')}<a href="#" onclick="mod.users.action({$r.obj_id}, 'ban', false); return false;"><img src="{$tsRoutes.tema.images}/icons/power_off.png" title="Suspender Usuario" /></a>{/if}
                                                    {if $tsUser->is_admod || $tsUser->can('modu')}<a href="#" onclick="mod.reboot({$r.obj_id}, 'users', 'reboot', false); return false"><img src="{$tsRoutes.tema.images}/icons/close.png" title="Cancelar denuncias" /></a>{/if}
                                                </td>
                                            </tr>
                                            {/foreach}{else}
                                            <tr>
