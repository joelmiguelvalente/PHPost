								...
								<table cellpadding="0" cellspacing="0" border="0" class="admin_table" width="100%" align="center">
									...
									<tbody>
										...
										<tr id="report_{$f.foto_id}">
											...
											<td><a href="{$tsConfig.url}/@{$f.user_name}" class="hovercard" uid="{$f.user_id}">{$f.user_name}</a></td>
											<td><a href="{$tsConfig.url}/@{$f.mod_name}" class="hovercard" uid="{$f.mod}">{$f.mod_name}</a></td>
