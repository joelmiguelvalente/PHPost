                                        ...
                                        <tbody>{foreach from=$tsAfiliados item=af}
                                        	<tr id="few_{$af.aid}">
                                                ...
                                                <td class="admin_actions">
                                                    <a href="afs/editar/{$af.aid}"><img src="{$tsRoutes.tema.images}/icons/editar.png" title="Editar"/></a>
                                                    <a href="#" onclick="ad_afiliado.detalles({$af.aid}); return false;"><img src="{$tsRoutes.tema.images}/icons/details.png" title="Detalles"/></a>
													<a onclick="admin.afs.accion({$af.aid}); return false"><img src="{$tsRoutes.tema.images}/reactivar.png" title="Activar/Desactivar Afiliado" /></a>
                                                    <a href="#" onclick="admin.afs.borrar({$af.aid}); return false"><img src="{$tsRoutes.tema.images}/icons/close.png" title="Eliminar"/></a>
                                                </td>
                                            </tr>{/foreach}
                                        </tbody>
                                    </table>
