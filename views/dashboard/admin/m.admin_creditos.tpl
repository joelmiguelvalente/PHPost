<h1 class="text-xl font-semibold mb-4">Soporte y Créditos</h1>
<div class="space-y-6">
   ...
   <section class="rounded-lg border bg-white dark:bg-surface p-5 shadow-sm">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3 text-sm">
         <div>
            ...
            <div class="font-medium">{$tsVersion.script}</div>
         </div>
         <div>
            <div class="text-gray-500 dark:text-gray-400">Versión de Smarty</div>
            <div class="font-medium">{$smarty.version}</div>
         </div>
   ...
   <section class="rounded-lg border bg-white dark:bg-surface p-5 shadow-sm">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-x-6 gap-y-3 text-sm">
         ...
         <div>
            <div class="text-gray-500 dark:text-gray-400">PDO</div>
            <div class="font-medium">
               {if $tsVersion.extensions.pdo}
                  <span class="text-green-600">Habilitado</span>
               {else}
                  <span class="text-red-600">No habilitada</span>
               {/if}
         ...
         <div>
            <div class="text-gray-500 dark:text-gray-400">JSON</div>
            <div class="font-medium">
               {if $tsVersion.extensions.json}
                  <span class="text-green-600">Habilitado</span>
               {else}
                  <span class="text-red-600">Requerido</span>
               {/if}
         ...
         <div>
            <div class="text-gray-500 dark:text-gray-400">OpenSSL (opcional)</div>
            <div class="font-medium">
         ...
         <div>
            <div class="text-gray-500 dark:text-gray-400">FileInfo (opcional)</div>
            <div class="font-medium">
               {if $tsVersion.extensions.fileinfo}
                  <span class="text-green-600">Habilitado</span>
               {else}
                  <span class="text-red-600">No habilitada</span>
               {/if}
         ...
         <div>
            <div class="text-gray-500 dark:text-gray-400">Zip (opcional)</div>
            <div class="font-medium">
               {if $tsVersion.extensions.zip}
