...
| Version | Soportado          |
| ------- | ------------------ |
| 8.4.13  | :white_check_mark: |
|  8.5.0  | :white_check_mark: |

## Informar de una vulnerabilidad

Si ha descubierto un problema de seguridad con PHPost, contáctenos al portfoliomiguel92@gmail.com. No divulgue sus hallazgos públicamente y POR FAVOR, POR FAVOR, no presente un Problema.
