...
class BBCode {
	...
	private function getBasicTags(): array {
	   return [
	      ...
	      'error'  => '<div class="bbcmsg error">{param}</div>',
	      'info'   => '<div class="bbcmsg info">{param}</div>',
	      'notice' => '<div class="bbcmsg notice">{param}</div>',
	      'success'=> '<div class="bbcmsg success">{param}</div>',
	      'warning'=> '<div class="bbcmsg warning">{param}</div>',
